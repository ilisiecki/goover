                ...
                <div
                  ...
                  className={cn("relative rounded-2xl bg-white shadow-lg", {
                    "border-2 border-purple-600 shadow-purple-200":
                      plan === "Pro",
                    "border border-neutral-200": plan !== "Pro",
                  })}
                >
                  {plan === "Pro" && (
                  ...
                  <div className="flex h-20 items-center justify-center border-b border-t border-neutral-200 bg-neutral-50">
                    ...
                    {features.map(({ text, footnote, negative }) => (
                      <li key={text} className="flex space-x-5">
                        <div className="flex-shrink-0">
                          {negative ? (
                            <MinusIcon className="h-6 w-6 text-neutral-300" />
                          ) : (
